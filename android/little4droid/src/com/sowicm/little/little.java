...
{
    public final static String strUrlPath = "http://my.zi-jin.com/little";
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        String urlSList = strUrlPath + "/slist.php";
    ...
    public static void sendCmd(String strCmd)
    {
    	...
    	String urlCmd = strUrlPath + "/little.php?key=KDIWXCBKPACVNMZ"
    	        + urlts
    	        + "&q="
    ...
    public void onbtnSendStringClk(View v)
    {
